...
You can download the dataset by running (the datasets for router and chain summary are included in this repo):
...
wget https://huggingface.co/datasets/kmfoda/booksum/resolve/main/train.csv
```
