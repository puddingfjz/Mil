...
class LLMEngine:
    ...
    def __init__(
        ...
        # <> Support backup workers to avoid re-launch ray actors
    ...
    # TODO (): check what is driver worker and whether our code can still work
    ...
    def _init_workers_ray_ori(self, placement_group: "PlacementGroup",
        ...
        for bundle_id, bundle in enumerate(placement_group.bundle_specs):
            ...
            worker = ray.remote(
                ...
                # TODO <> support changing env variables as we cannot init ray twice where the env variables in actors are initialized
        ...
        for node_id, gpu_ids in node_gpus.items():
            # <> we keep the visible gpus in the same order as we specify them
    ...
    def _init_cache_ori(self) -> None:
        ...
        # <> after updating KVBlkPerLayerWeight in each worker, we update KVBlkPerLayerWeight in the main process as well------
    ...
    # <> this function gets the reused cache profiling results from our profiling database
    def get_reused_cache_profile_result(self) -> Tuple[int, int, Tuple[int, int]]:
        ...
        # TODO () need to update the database
    ...
    # <> this function init the KV cache by reusing previous profiling result
    ...
    def update_engine(
        ...
        # Create the scheduler.
        # TODO () need to update scheduler instead of reinitialize it if we want to reuse KV cache
        self.scheduler = Scheduler(scheduler_config, cache_config, lora_config)
    ...
    def _process_sequence_group_outputs(self, seq_group: SequenceGroup,
        ...
        for seq, _ in child_seqs:
            ...
            # # <> FOR DEBUG
            # if seq.is_finished():
            #     print(f"request_id: {seq_group.request_id}, seq.status: {seq.status}, seq.get_output_len(): {seq.get_output_len()}, sampling_params.max_tokens: {seq_group.sampling_params.max_tokens}")
    ...
    def step(self) -> List[RequestOutput]:
        ...
        # <> we need to reset KVBlkPerLayerWeight.load_more_layer_on_card_num after we use it
    ...
    # <> delete worker to release resources
