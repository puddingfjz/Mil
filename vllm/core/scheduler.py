...
class SchedulerOutputs:
    ...
    def __init__(
        ...
        # <> to reorganize the KV cache blocks to make space for model weights 
...
class Scheduler:
        ...
        if not self.swapped:
            ...
            while self.waiting:
                ...
                assert len(waiting_seqs) == 1, (
                    ...
                    "sequence.", seq_group, waiting_seqs) # <> For DEBUG
    ...
    def schedule(self) -> Tuple[List[SequenceGroupMetadata], SchedulerOutputs]:
        ...
        # <> try reorganize blocks before schedule 
    ...
    def increase_layer_weight_on_comp_gpu(self, blocks_to_copy: Dict[int, List[int]]) -> None:
        ...
        # TODO (): we assume all the pipe_degree and pipeinteval can divide layer_num perfectly
