...
// Grid: (num_layers, num_pairs)
// <> this function is used to reorganize KV cache blocks to make enough memory for model weights
template<typename scalar_t>
__global__ void reorganize_blocks_kernel_deprecated(
  ...
  // <> this condition is wrong, as value cache and new value cache can never be at the same place
